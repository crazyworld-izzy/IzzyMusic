...
from IzzyMusic import Telegram, YouTube, app
from IzzyMusic.misc import SUDOERS
from IzzyMusic.plugins.play.playlist import del_plist_msg
from IzzyMusic.plugins.sudo.sudoers import sudoers_list
from IzzyMusic.utils.database import (
    add_served_chat,
    add_served_user,
    blacklisted_chats,
    get_assistant,
...
from IzzyMusic.utils.decorators.language import LanguageStart
from IzzyMusic.utils.inline import help_pannel, private_panel, start_pannel
from IzzyMusic.utils.command import commandpro
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[Tᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/cute_girl_support) ** Pʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
